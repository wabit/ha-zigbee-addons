...
Applies Hue-native power-on-behavior settings to Signify/Philips Hue lights
in Zigbee2MQTT, and to any groups that contain them.
...
3. Set the desired `hue_power_on_*` values in the add-on configuration.
4. Start the add-on.
